...
import { getAllUsers,createUser,updateUser,deleteUser,toggleStatus } from "../services/userService";
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredUsers.map((user) => (
                  <tr key={user._id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-gray-700">{user.role}</td>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    <div className="sm:col-span-2">
                      ...
                      <input
                        type="text"
                        value={userData.name}
                        onChange={(e) => { setUserData({ ...userData, name: e.target.value }); setErrorMsg(""); }}
