...
export default function ManagerDashboard({ role }) {
  ...
  const handleNext = () => {
    ...
    if (wizardStep === 1) {
      ...
      if ( newAppointmentData.appointmentDate < todayDate ||  newAppointmentData.appointmentDate > maxAppointmentDate)
       {
         setErrorMsg( "Appointments can only be booked for today, tomorrow, or the day after tomorrow.");
         return;
       }
      setWizardStep(3);
          ...
          <div className="p-3 sm:p-4 lg:p-8 w-full max-w-7xl mx-auto overflow-x-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto justify-center"
              >
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <button
                ...
                className={`px-4 py-2 sm:px-6 rounded-lg text-sm font-medium transition-colors flex-1 sm:flex-none ${
                  tab === "appointments"
              ...
              <button
                ...
                className={`px-4 py-2 sm:px-6 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 flex-1 sm:flex-none ${
                  tab === "ip-discharge"
                    ? "bg-blue-600 text-white"
                    : "bg-white text-gray-600 border border-gray-200 hover:bg-gray-50"
                }`}
            ...
            {errorMsg && (
              <div className="mb-4 p-3 bg-red-50 text-red-700 text-sm font-medium rounded-lg border border-red-100 flex items-center gap-2 flex-wrap">
            ...
            {tab === "appointments" && (
              <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                <div className="px-4 py-3 sm:px-5 sm:py-4 border-b border-gray-100 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
                  <div className="flex items-center gap-3 flex-1 min-w-[200px] bg-gray-50 px-3 py-2 rounded-lg border border-gray-200">
                    ...
                    <thead className="bg-gray-50/50 border-b border-gray-100">
                      <tr>
                        {[
                          ...
                          <th
                            key={h}
                            className="px-3 sm:px-5 py-3 sm:py-4 text-left font-semibold text-gray-500 text-xs uppercase tracking-wider"
                          >
                            {h}
                          </th>
                        ))}
                      ...
                      {loading ? (
                        ...
                        filtered.map((a) => (
                          ...
                          >
                            ...
                            <td className="px-3 sm:px-5 py-3 sm:py-4 text-gray-500 font-medium">
                              {getPatientPid(a)}
                            </td>
                            <td className="px-3 sm:px-5 py-3 sm:py-4 text-gray-900 font-medium">
                              {getPatientName(a)}
                            </td>
                            <td className="px-3 sm:px-5 py-3 sm:py-4 text-gray-600">
                              {getDoctorName(a, doctors)}
                            </td>
                            <td className="px-3 sm:px-5 py-3 sm:py-4 text-gray-500">
                        ...
                        ipDischarges.map((adm) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-3 sm:px-5 py-3 sm:py-4 text-gray-900">
                                Rs. {total}
                              </td>
                              <td className="px-3 sm:px-5 py-3 sm:py-4 text-green-600">
                                Rs. {paid}
                              </td>
                              <td className="px-3 sm:px-5 py-3 sm:py-4 text-red-600 font-medium">
                                Rs. {pending}
                              </td>
                              <td className="px-3 sm:px-5 py-3 sm:py-4">
                                <span
                              ...
                              <td className="px-3 sm:px-5 py-3 sm:py-4">
                                {adm.status === "Pending" ? (
                                  <button
                                    ...
                                    className="text-xs bg-blue-50 text-blue-700 border border-blue-200 rounded px-3 py-1.5 font-medium hover:bg-blue-100 transition-colors w-full sm:w-auto"
                                    disabled={loading}
                                  >
                                    View & Discharge
                                  </button>
            ...
            {showModal && isNewAppointmentWizard && (
              <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4">
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[95vh] sm:max-h-[90vh] modal-content">
                  <div className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between border-b border-gray-100 flex-shrink-0">
                  ...
                  <div className="p-3 sm:p-6 overflow-y-auto flex-1">
                    {/* Step indicator */}
                    {wizardStep < 4 && (
                      <div className="flex items-center gap-2 sm:gap-4 mb-6 text-xs sm:text-sm font-medium">
                      ...
                      <div>
                        ...
                        {patientMode === "new" ? (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="rounded-lg border border-gray-200 overflow-hidden shadow-sm max-h-64 overflow-y-auto">
                              <table className="w-full text-sm">
                                <thead className="bg-gray-50 border-b border-gray-200 sticky top-0">
                                  <tr>
                                    <th className="px-3 sm:px-4 py-2.5 text-left font-semibold text-gray-600">
                                      PID
                                    </th>
                                    <th className="px-3 sm:px-4 py-2.5 text-left font-semibold text-gray-600">
                                      Name
                                    ...
                                    .map((patient) => (
                                      <tr
                                        ...
                                        className={`cursor-pointer ${
                                          ...
                                          (patient._id || patient.pid)
                                            ? "bg-blue-50"
                                            : "hover:bg-gray-50"
                                        }`}
                                      >
                                        <td className="px-3 sm:px-4 py-3 font-medium text-gray-600">
                                          {patient.pid}
                                        </td>
                    ...
                    {wizardStep === 2 && (
                      <div className="space-y-5">
                        <div className="rounded-lg border border-blue-100 bg-blue-50 p-3 text-sm flex flex-wrap gap-4 shadow-sm">
                          ...
                          <div className="w-px h-8 bg-blue-200 hidden sm:block"></div>
                          <div>
                            <span className="text-gray-500 text-xs block">
                              PID
                            </span>
                            ...
                            {["Cash", "UPI", "Card"].map((method) => (
                              <button
                                ...
                                className={`rounded-lg border px-3 py-3 text-sm font-semibold transition-all ${
                                  newAppointmentData.paymentMethod === method
                    ...
                    {wizardStep === 4 && (
                      <div className="py-2">
                        <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-xl overflow-hidden shadow mb-4">
                          <div className="bg-green-50 border-b border-green-100 px-4 sm:px-5 py-3 sm:py-4 flex items-center justify-between">
                            <div>
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-100">
                        ...
                        <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-3">
                          <button
                            ...
                            className="w-full sm:w-auto px-5 py-2 text-sm font-semibold text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
                          >
                          ...
                          <button
                            ...
                            onClick={handleNext}
                            disabled={loading}
                            className={`w-full sm:w-auto px-6 py-2 text-sm font-semibold text-white rounded-lg flex items-center justify-center gap-2 shadow-sm ${
                              wizardStep === 3
            ...
            {dischargeModal && (
              <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4">
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-md flex flex-col max-h-[95vh] modal-content">
                  <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-gray-100 flex justify-between items-center flex-shrink-0">
